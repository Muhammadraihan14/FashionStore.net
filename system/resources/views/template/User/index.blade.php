                ...
                <div class="col-md-12 mt-5 ">
                        ...
                        <div class="card">
                          <div class="card-header">
                                Data User
                                {{-- admin/ --}}
                                <a href="{{url ('user/create')}} " class="btn btn-success float-right"><i class="fa fa-plus"></i>  Tambah data</a>
                        </div>
                        <div class="card-body">
                                <table class="table table-data table">
                                    ...
                                    <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="{{url ('user', $user->id_user)}}" class="btn bg-secondary"><i class="fa fa-info"></i></a>
                                                        <a href="{{url ('user', $user->id_user)}}/edit" class="btn bg-warning"><i class="fa fa-edit"></i></a>
                                                        ...
                                                        @include('template.utils.delete', ['url' => url ('user', $user->id_user)])
                                                        </div>
                                                </td>
                                                <td>{{$user->nama}}</td>
                                                <td>{{$user->alamat}}</td>
