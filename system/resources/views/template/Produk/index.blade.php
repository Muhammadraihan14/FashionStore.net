                                ...
                                <table class="table table-data table">
                                    ...
                                    <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="{{url ('produk', $produk->id_produk)}}" class="btn bg-secondary"><i class="fa fa-info"></i></a>
                                                        <a href="{{url ('produk', $produk->id_produk)}}/edit" class="btn bg-warning"><i class="fa fa-edit"></i></a>
                                                        ...
                                                        @include('template.utils.delete', ['url' => url ('produk', $produk->id_produk)])
                                                        </div>
                                                </td>
